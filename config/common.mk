...
PRODUCT_COPY_FILES += \
    ...
    vendor/cm/prebuilt/common/app/org.notphenom.swe.browser-1/lib/arm/libswe.so.cr.so:system/app/org.notphenom.swe.browser-1/lib/arm/libswe.cr.so \
...
ifeq ($(CM_BUILDTYPE), RELEASE)
    ...
    CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date -u +%Y%m%d)-MARSH-2.0.2$(CM_EXTRAVERSION)-$(CM_BUILD)
endif
